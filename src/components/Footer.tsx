        ...
        <div className="lg:col-span-2 pr-0 lg:pr-12">
          ...
          <div className="flex gap-4">
            <a 
              ...
              className="w-10 h-10 rounded-full bg-stone-900 flex items-center justify-center hover:bg-amber-900 hover:text-white transition-colors"
            >
        ...
        <div>
          ...
          <ul className="space-y-4">
            ...
            <li className="flex items-start">
              ...
              <a href={getWhatsAppLink()} target="_blank" rel="noopener noreferrer" className="hover:text-amber-500 transition-colors">Solicitar Cotización</a>
            </li>
          </ul>
        </div>
